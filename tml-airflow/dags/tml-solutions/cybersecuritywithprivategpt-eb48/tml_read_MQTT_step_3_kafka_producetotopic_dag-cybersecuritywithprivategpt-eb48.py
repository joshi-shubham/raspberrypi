...
default_args = {
  ...
  'mqtt_broker' : '07bed4a05a7e431d9a29c9836f75946b.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-eb48", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-eb48"], schedule=None,catchup=False)
